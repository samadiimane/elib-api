"""Seed Dar al-Niaba issue 18 articles.

Usage:
    python -m scripts.seed_dar_al_niaba_issue_18
    python -m scripts.seed_dar_al_niaba_issue_18 dar-al-niaba-18-2
...
ISSUE = {
    ...
    "title": "العدد الثامن عشر، السنة الخامسة، ربيع 1988",
    "year": 1988,
    "volume": 5,
    "number": 18,
}
...
ARTICLES = [
    {
        ...
        "start_page": 1,
        "end_page": 4,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-18-1.pdf",
    },
    {
        "title": "حركة التعاون السكني بطنجة : ظاهرة وتجربة",
        "authors": ["آيت حمزة محمد"],
        "lang": "ar",
        "pages": 9,
        "start_page": 5,
        "end_page": 13,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-18-2.pdf",
    },
    {
        "title": "طنجة في عهد الادارة الدولية",
        "authors": ["محمد الأمين البزاز"],
        "lang": "ar",
        "pages": 11,
        "start_page": 14,
        "end_page": 24,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-18-3.pdf",
    },
    {
        "title": "العلاقات الروسية المغربية في القرن التاسع عشر",
        "authors": ["ناتيانا موساتوفا", "عبد الرحيم العطاوي"],
        "lang": "ar",
        "pages": 7,
        "start_page": 25,
        "end_page": 31,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-18-4.pdf",
    },
    {
        "title": "قضية \"الجوازيط\" الأجنبية بطنجة خلال الربع الأخير من القرن التاسع عشر",
        "authors": ["جامع بيضا"],
        "lang": "ar",
        "pages": 8,
        "start_page": 32,
        "end_page": 39,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-18-5.pdf",
    },
    {
        "title": "ملامح من تاريخ طنجة في العصر الوسيط",
        "authors": ["إبراهيم حركات"],
        "lang": "ar",
        "pages": 6,
        "start_page": 40,
        "end_page": 45,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-18-6.pdf",
    },
    {
        "title": "تقويم سياسي عام للنظام الحماية الإسبانية على المغرب الشمالي (1912 - 1956)",
        "authors": ["عبد العزيز التمسماني خلوق"],
        "lang": "ar",
        "pages": 11,
        "start_page": 46,
        "end_page": 56,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-18-7.pdf",
    },
    {
        "title": "الحماية الإسبانية بشمال المغرب من خلال « عمدة الراوين في تاريخ تطاوين » لفقيه أحمد الرهوني",
        "authors": ["عبد العزيز التمسماني خلوق"],
        "lang": "ar",
        "pages": 13,
        "start_page": 57,
        "end_page": 69,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-18-8.pdf",
    },
    {
        "title": "وثائق حول التاريخ الديني للمغرب في القرنين 5 و 6 هـ: مدخل لدراسة علاقة السلطة بقوى التصوف ( الجزء الثاني )",
        "authors": ["إبراهيم القادري بوتشيش"],
        "lang": "ar",
        "pages": 6,
        "start_page": 70,
        "end_page": 75,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-18-9.pdf",
    },
    {
        "title": "Le Centre Culturel Français de Tanger",
        "authors": ["Georges BOUSQUET"],
        "lang": "fr",
        "pages": 2,
        "start_page": 24,
        "end_page": 25,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-18-10.pdf",
    },
]
