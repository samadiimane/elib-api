"""Seed Dar al-Niaba issue 17 articles.

Usage:
    python -m scripts.seed_dar_al_niaba_issue_17
    python -m scripts.seed_dar_al_niaba_issue_17 dar-al-niaba-17-2
...
ISSUE = {
    ...
    "title": "العدد السابع عشر، السنة الخامسة، شتاء 1988",
    "year": 1988,
    "volume": 5,
    "number": 17,
}
...
ARTICLES = [
    {
        ...
        "start_page": 1,
        "end_page": 4,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-17-1.pdf",
    },
    {
        "title": "اتجاه جديد للبحث التاريخي في المغرب",
        "authors": ["جرمان عياش"],
        "lang": "ar",
        "pages": 8,
        "start_page": 5,
        "end_page": 12,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-17-2.pdf",
    },
    {
        "title": "الاصلاحات العسكرية بالمغرب في القرن التاسع عشر",
        "authors": ["محمد الغماري"],
        "lang": "ar",
        "pages": 6,
        "start_page": 13,
        "end_page": 18,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-17-3.pdf",
    },
    {
        "title": "وثائق حول التاريخ الديني للمغرب في القرنين 5 و 6 هـ : مدخل لدراسة علاقة السلطة بقوى التصوف",
        "authors": ["إبراهيم القادري بوتشيش"],
        "lang": "ar",
        "pages": 5,
        "start_page": 19,
        "end_page": 23,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-17-4.pdf",
    },
    {
        "title": "المقاومة المغربية الدبلوماسية للهيمنة الفرنسية (1904 - 1905)",
        "authors": ["عبد العزيز التمسماني خلوق"],
        "lang": "ar",
        "pages": 5,
        "start_page": 24,
        "end_page": 28,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-17-5.pdf",
    },
    {
        "title": "صور من الانبعاث المغربي في عصر السلطان الحفيظ - أعمال وأعلام",
        "authors": ["محمد المنوني"],
        "lang": "ar",
        "pages": 18,
        "start_page": 29,
        "end_page": 46,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-17-6.pdf",
    },
    {
        "title": "الحركة الحفيظية والأطماع الاسبانية في شمال المغرب",
        "authors": ["عبد العزيز التمسماني خلوق"],
        "lang": "ar",
        "pages": 34,
        "start_page": 47,
        "end_page": 80,
        "file_key": "dar-al-niaba/pdf/dar-al-niaba-17-7.pdf",
    },
]
