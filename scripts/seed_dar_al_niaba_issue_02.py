"""Seed Dar al-Niaba issue 02 articles.

Usage:
    python -m scripts.seed_dar_al_niaba_issue_02
    python -m scripts.seed_dar_al_niaba_issue_02 dar-al-niaba-02-3
...
ISSUE = {'journal_slug': 'dar-al-niaba',
 'journal_name': 'Dar al-Niaba',
 'title': 'العدد الثاني، السنة الاولى، ربيع 1984',
 'year': 1984,
 'volume': 1,
 'number': 2}


ARTICLES = [{'title': 'افتتاحية',
  'authors': [],
  'lang': 'ar',
  'pages': 6,
  'start_page': 1,
  'end_page': 5,
  'file_key': 'dar-al-niaba/pdf/dar-al-niaba-02-1.pdf'},
 {'title': 'نماذج من ارتباط المغرب بالمشرق في مطالع القرن العشرين',
  'authors': ['محمد المنوني'],
  'lang': 'ar',
  'pages': 4,
  'start_page': 6,
  'end_page': 8,
  'file_key': 'dar-al-niaba/pdf/dar-al-niaba-02-2.pdf'},
 {'title': 'المساهمة الامريكية في الادارة الدولية لمنطقة طنجة',
  'authors': ['التهامي محمد الوكيلي'],
  'lang': 'ar',
  'pages': 8,
  'start_page': 10,
  'end_page': 17,
  'file_key': 'dar-al-niaba/pdf/dar-al-niaba-02-3.pdf'},
 {'title': 'رسالة من الفونسو السادس إلى يوسف بن تاشفين ومدى أصالتها',
  'authors': ['أمحمد بن عبود'],
  'lang': 'ar',
  'pages': 3,
  'start_page': 18,
  'end_page': 20,
  'file_key': 'dar-al-niaba/pdf/dar-al-niaba-02-4.pdf'},
 {'title': 'المجتمع المغربي والخطاب الادبي من 1900 الى 1930',
  'authors': ['الطريسي أحمد أعراب'],
  'lang': 'ar',
  'pages': 7,
  'start_page': 21,
  'end_page': 27,
  'file_key': 'dar-al-niaba/pdf/dar-al-niaba-02-5.pdf'},
 {'title': 'الغزو الاستعماري الاسباني لبلاد جبالة والمقاومة الشعبية من 1912 الــــى 1927',
  'authors': ['عبد العزيز التمسماني خلوق'],
  'lang': 'ar',
  'pages': 5,
  'start_page': 28,
  'end_page': 31,
  'file_key': 'dar-al-niaba/pdf/dar-al-niaba-02-6.pdf'},
 {'title': 'الجـــواح والقـــواصم',
  'authors': ['مصطفى بوشعراء'],
  'lang': 'ar',
  'pages': 14,
  'start_page': 33,
  'end_page': 46,
  'file_key': 'dar-al-niaba/pdf/dar-al-niaba-02-7.pdf'},
 {'title': 'ملاحظات حول ردود فعل بعض مفكري المغرب العربي تجاه مشكلة الوباء والحجر الصحي في القرنين 18 و 19',
  'authors': ['عبد المجيد الصغير'],
  'lang': 'ar',
  'pages': 5,
  'start_page': 47,
  'end_page': 51,
  'file_key': 'dar-al-niaba/pdf/dar-al-niaba-02-8.pdf'},
 {'title': 'وباء الطاعون بالمغرب (1798-1800)',
  'authors': ['محمد الأمين البزاز'],
  'lang': 'ar',
  'pages': 11,
  'start_page': 52,
  'end_page': 62,
  'file_key': 'dar-al-niaba/pdf/dar-al-niaba-02-9.pdf'},
 {'title': 'جوانب من موقف المخزن إبان الكوارث الطبيعية',
  'authors': ['محمد الأمين البزاز'],
  'lang': 'ar',
  'pages': 5,
  'start_page': 63,
  'end_page': 67,
  'file_key': 'dar-al-niaba/pdf/dar-al-niaba-02-10.pdf'},
 {'title': 'تفاحش مشكلة الحماية القنصلية بعد مؤتمر مدريد: قضية نهب قصبة مرزاب بالشاوية من خلال الوثائق (1896 - 1899)',
  'authors': ['محمد الأمين البزاز'],
  'lang': 'ar',
  'pages': 5,
  'start_page': 68,
  'end_page': 72,
  'file_key': 'dar-al-niaba/pdf/dar-al-niaba-02-11.pdf'},
 {'title': 'اتفاقية 16 نوفمبر 1910 بين المغرب واسبانيا',
  'authors': [],
  'lang': 'ar',
  'pages': 4,
  'start_page': 73,
  'end_page': 76,
  'file_key': 'dar-al-niaba/pdf/dar-al-niaba-02-12.pdf'},
 {'title': 'مشاركة المغرب في المؤتمر الدولي للبيطرة المنعقد بالمانيا من 7 الى 12 غشت 1899',
  'authors': [],
  'lang': 'ar',
  'pages': 2,
  'start_page': 77,
  'end_page': 78,
  'file_key': 'dar-al-niaba/pdf/dar-al-niaba-02-13.pdf'},
 {'title': 'محاربة ظاهرة التسول في مغرب ما قبل الحماية: «مثال تأسيس الجمعية الخيرية الاسلامية بطنجة سنة 1911',
  'authors': [],
  'lang': 'ar',
  'pages': 4,
  'start_page': 79,
  'end_page': 81,
  'file_key': 'dar-al-niaba/pdf/dar-al-niaba-02-14.pdf'}]
